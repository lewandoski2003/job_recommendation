...
unstructured_df.to_csv(r'C:\Users\saran\Desktop\AjeyPrasad-RVCE\AIML-NLP EL\Job-Recommendation-System-main\Job-Recommendation-System-main\src\data\jd_structured_data.csv', index=False)